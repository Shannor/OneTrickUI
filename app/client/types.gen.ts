...
export type Perk = {
  ...
  iconPath?: string;
  /**
   * Whether the perk is active or not.
   */
  isActive?: boolean;
  /**
   * Whether the perk is visible or not.
   */
  visible?: boolean;
};
...
export type GetWeaponsForActivityData = {
  path: {
    /**
...
export type GetWeaponsForActivityResponse = WeaponStats;

export type GetWeaponsForActivityError = unknown;
