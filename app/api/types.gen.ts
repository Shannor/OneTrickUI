...
export type CharacterSnapshot = {
  ...
  name: string;
  /**
   * Description of the snapshot. Will be empty by default and added by the user later.
   */
  description?: string;
  /**
...
export type UpdateSessionData = {
  /**
   * Provide the data to update for the session
   */
  body: {
    name: string;
    description?: string;
...
export type CompleteSessionData = {
  /**
   * Provide the character to complete the session for
   */
  body: {
    characterId: string;
    name?: string;
...
export type CompleteSessionResponse =
  CompleteSessionResponses[keyof CompleteSessionResponses];
